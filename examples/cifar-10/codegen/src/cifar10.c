...
void cifar10(const xc_conv2d_shallowin_deepout_relu_input_t *XC_conv2d_shallowin_deepout_relu_input, xc_argmax_16_output_t *XC_argmax_16_output)
{
     ...
     conv2d_deepin_deepout_relu(XC_conv2d_deepin_deepout_relu_1_weights, (data16_t *)XC_conv2d_deepin_deepout_relu_1_biases, (int8_t *)sequential_max_pooling2d_1_MaxPool, sequential_re_lu_2_Relu, 8, 8, 5, 5, 64, 32, (int16_t*) &XC_conv2d_deepin_deepout_relu_1_shift_scale[0], (int16_t*) &XC_conv2d_deepin_deepout_relu_1_shift_scale[64]);
