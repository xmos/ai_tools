...
#define X_WIDTH         (1)
#define Y_WIDTH         (1)
void test_nn_conv2d_hstrip_tail_im2col_case0()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int v = start_case; v < N_casses && v <= stop_case; v++){
        ...
        for(int C_out = 4; C_out <= 12; C_out += 4){
            ...
            nn_conv2d_hstrip_tail_im2col((nn_image_t*) Y, (nn_image_t*) X, K_init, (nn_bso_block_t*) &bso, 
...
#define K_w             (1)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_tail_im2col_case1()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int v = start_case; v < N_casses && v <= stop_case; v++){
        ...
        for(int C_out = 4; C_out <= 12; C_out += 4){
            ...
            PRINTF("\t\t\tC...\n");
            memset(Y, 0xCC, sizeof(Y));
            nn_conv2d_hstrip_tail_im2col((nn_image_t*) Y, X_patch_start, K_init, (nn_bso_block_t*) &bso, 
                                            K_h, K_hstride, x_params.channels, x_v_stride, y_params.channels, 
                                            y_params.width, y_params.channels);
...
#define K_w             (3)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_tail_im2col_case2()
{
    PRINTF("%s...\n", __func__);
...
#define K_w             (3)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_tail_im2col_case3()
{
    PRINTF("%s...\n", __func__);
...
#define K_w             (1)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_tail_im2col_case4()
{
    PRINTF("%s...\n", __func__);
...
void test_nn_conv2d_hstrip_tail_im2col()
{
    UNITY_SET_FILE();

    RUN_TEST(test_nn_conv2d_hstrip_tail_im2col_case0);
    RUN_TEST(test_nn_conv2d_hstrip_tail_im2col_case1);
    RUN_TEST(test_nn_conv2d_hstrip_tail_im2col_case2);
    RUN_TEST(test_nn_conv2d_hstrip_tail_im2col_case3);
    RUN_TEST(test_nn_conv2d_hstrip_tail_im2col_case4);
}