...
void xcore_model_quant(const xc_conv2d_shallowin_deepout_relu_input_t *XC_conv2d_shallowin_deepout_relu_input, xc_argmax_16_output_t *XC_argmax_16_output)
{
     ...
     conv2d_deepin_deepout_relu(XC_conv2d_deepin_deepout_relu_weights, (data16_t *)XC_conv2d_deepin_deepout_relu_biases, sequential_max_pooling2d_MaxPool, sequential_re_lu_1_Relu, 16, 16, 5, 5, 2, 32, (int16_t*) &XC_conv2d_deepin_deepout_relu_shift_scale[0], (int16_t*) &XC_conv2d_deepin_deepout_relu_shift_scale[2]);
     maxpool2d_deep(sequential_re_lu_1_Relu, sequential_max_pooling2d_1_MaxPool, 16, 16, 32);
     conv2d_deepin_deepout_relu(XC_conv2d_deepin_deepout_relu_1_weights, (data16_t *)XC_conv2d_deepin_deepout_relu_1_biases, sequential_max_pooling2d_1_MaxPool, sequential_re_lu_2_Relu, 8, 8, 5, 5, 4, 32, (int16_t*) &XC_conv2d_deepin_deepout_relu_1_shift_scale[0], (int16_t*) &XC_conv2d_deepin_deepout_relu_1_shift_scale[4]);
