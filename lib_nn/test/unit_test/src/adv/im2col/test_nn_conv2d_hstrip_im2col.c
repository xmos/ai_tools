...
#define X_WIDTH         (1)
#define Y_WIDTH         (1)
void test_nn_conv2d_hstrip_im2col_case0()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int v = start_case; v < N_casses && v <= stop_case; v++){
        ...
        nn_conv2d_hstrip_im2col((nn_image_t*) Y, (nn_image_t*) X, K_init, (nn_bso_block_t*) &bso, 
...
#define K_w             (1)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_im2col_case1()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int v = start_case; v < N_casses && v <= stop_case; v++){
        ...
        memset(Y, 0xCC, sizeof(Y));
        nn_conv2d_hstrip_im2col((nn_image_t*) Y, X_patch_start, K_init, (nn_bso_block_t*) &bso, 
                                        K_h, K_hstride, x_params.channels, 
                                        x_v_stride, y_params.channels, y_params.width);
...
#define K_w             (3)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_im2col_case2()
{
    PRINTF("%s...\n", __func__);
...
#define K_w             (3)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_im2col_case3()
{
    PRINTF("%s...\n", __func__);
...
#define K_w             (1)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_im2col_case4()
{
    PRINTF("%s...\n", __func__);
...
void test_nn_conv2d_hstrip_im2col()
{
    ...
    RUN_TEST(test_nn_conv2d_hstrip_im2col_case0);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_case1);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_case2);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_case3);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_case4);
}
