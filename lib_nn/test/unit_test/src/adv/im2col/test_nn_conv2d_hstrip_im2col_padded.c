...
void test_nn_conv2d_hstrip_im2col_padded_case0()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int v = start_case; v < N_casses && v <= stop_case; v++){
        ...
        nn_conv2d_hstrip_im2col_padded((nn_image_t*) Y, (nn_image_t*) X, K_init, (nn_bso_block_t*) &bso, 
...
void test_nn_conv2d_hstrip_im2col_padded_case1()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int v = start_case; v < N_casses && v <= stop_case; v++){
        ...
        for(int pad_t = 0; pad_t < 3; pad_t++){
            ...
            memset(Y, 0xCC, sizeof(Y));
            nn_conv2d_hstrip_im2col_padded((nn_image_t*) Y, X_patch_start, K_init, (nn_bso_block_t*) &bso, 
                                            K_h, K_hstride, x_params.channels, pad_t, pad_b, pad_l, pad_r,
                                            x_v_stride, y_params.channels, y_params.width, zero_point_vec);
...
#define K_w             (3)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_im2col_padded_case2()
{
    PRINTF("%s...\n", __func__);
...
#define K_w             (3)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_im2col_padded_case3()
{
    PRINTF("%s...\n", __func__);
...
#define K_hstride       (1)
#define ZERO_POINT      (0xCC)
void test_nn_conv2d_hstrip_im2col_padded_case4()
{
    PRINTF("%s...\n", __func__);
...
#define K_w             (3)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_im2col_padded_case5()
{
    PRINTF("%s...\n", __func__);
...
#define K_w             (1)
#define K_hstride       (1)
void test_nn_conv2d_hstrip_im2col_padded_case6()
{
    PRINTF("%s...\n", __func__);
...
void test_nn_conv2d_hstrip_im2col_padded()
{
    ...
    RUN_TEST(test_nn_conv2d_hstrip_im2col_padded_case0);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_padded_case1);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_padded_case2);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_padded_case3);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_padded_case4);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_padded_case5);
    RUN_TEST(test_nn_conv2d_hstrip_im2col_padded_case6);
}
