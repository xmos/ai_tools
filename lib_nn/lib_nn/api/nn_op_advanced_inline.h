...
static inline void nn_conv2d_hstrip_shallowin_padded(
        ...
        const int8_t* zero_point_vec)
{
#if defined(__XS3A__) && (USE_ASM_nn_conv2d_hstrip_shallowin_padded)

    nn_conv2d_hstrip_shallowin_padded_asm(Y, X, K, BSS, K_h, K_h_stride, C_in,
                                        pad_t, pad_b, pad_l_initial, pad_r_initial, 
                                        x_v_stride, y_h_stride, out_cols, zero_point_vec);

#else

    nn_conv2d_hstrip_shallowin_padded_c(Y, X, K, BSS, K_h, K_h_stride, C_in,
                                        pad_t, pad_b, pad_l_initial, pad_r_initial, 
                                        x_v_stride, y_h_stride, out_cols, zero_point_vec);
