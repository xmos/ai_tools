...
#if !defined(USE_ASM_nn_conv2d_hstrip_shallowin_padded) && !(DISABLE_ASM)
#define USE_ASM_nn_conv2d_hstrip_shallowin_padded  (1)
#endif
...
#if !defined(USE_ASM_nn_conv2d_hstrip_tail_shallowin_padded) && !(DISABLE_ASM)
#define USE_ASM_nn_conv2d_hstrip_tail_shallowin_padded  (1)
#endif
void nn_conv2d_hstrip_tail_shallowin_padded_asm(
        nn_image_t* Y,
        const nn_image_t* X,
        const nn_tensor_t* K,
        const nn_bss_block_t* BSS,
