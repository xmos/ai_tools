...
void xcore_model_quant(const int8_t *XC_conv2d_shallowin_deepout_relu_input, int32_t *XC_argmax_16_output)
{
     ...
     // conv2d_shallowin_deepout_relu(XC_conv2d_shallowin_deepout_relu_weights, (data16_t *)XC_conv2d_shallowin_deepout_relu_biases, XC_conv2d_shallowin_deepout_relu_input, sequential_re_lu_Relu, 32, 32, 5, 8, 32, &XC_conv2d_shallowin_deepout_relu_shift_scale[0], &XC_conv2d_shallowin_deepout_relu_shift_scale[1]);
     maxpool2d_deep(sequential_re_lu_Relu, sequential_max_pooling2d_MaxPool, 32, 32, 32);
     // conv2d_deepin_deepout_relu(XC_conv2d_deepin_deepout_relu_weights, (data16_t *)XC_conv2d_deepin_deepout_relu_biases, sequential_max_pooling2d_MaxPool, sequential_re_lu_1_Relu, 16, 16, 5, 5, 32, 32, &XC_conv2d_deepin_deepout_relu_shift_scale[0], &XC_conv2d_deepin_deepout_relu_shift_scale[1]);
     maxpool2d_deep(sequential_re_lu_1_Relu, sequential_max_pooling2d_1_MaxPool, 16, 16, 32);
     // conv2d_deepin_deepout_relu(XC_conv2d_deepin_deepout_relu_1_weights, (data16_t *)XC_conv2d_deepin_deepout_relu_1_biases, sequential_max_pooling2d_1_MaxPool, sequential_re_lu_2_Relu, 8, 8, 5, 5, 64, 32, &XC_conv2d_deepin_deepout_relu_1_shift_scale[0], &XC_conv2d_deepin_deepout_relu_1_shift_scale[1]);
     maxpool2d_deep(sequential_re_lu_2_Relu, sequential_max_pooling2d_2_MaxPool, 8, 8, 64);
     fc_deepin_shallowout_lin(XC_fc_deepin_shallowout_final_weights, XC_fc_deepin_shallowout_final_biases, sequential_max_pooling2d_2_MaxPool, XC_fc_deepin_shallowout_final_output, 10, 64, (uint16_t*) &XC_fc_deepin_shallowout_final_shift_scale[0], &XC_fc_deepin_shallowout_final_shift_scale[1]);
     //TODO: argmax_16();
}
