...
void test_fc_deepin_shallowout_8_case1()
{
    ...
    PRINTF("test_fc_deepin_shallowout_8_case1()...\n");

#if TEST_C
    PRINTF("\tC...\n");
    int8_t  WORD_ALIGNED  Y_c[C_out];
    memset(Y_c, 0xCC, sizeof(Y_c));
    fc_deepin_shallowout_8_c((int8_t*) W, B, X, Y_c, 
    ...
    fc_deepin_shallowout_8_asm((int8_t*) W, B, X, Y_asm, 
                               C_out, C_in, shifts, scales);
#endif
...
{
    int8_t   WORD_ALIGNED  W[C_out][C_in]                = {
    ...
    int32_t  WORD_ALIGNED  B[C_out]                      = { 0, -1, 0, -2,};
    int8_t   WORD_ALIGNED  X[C_in] = { 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, };
    uint16_t WORD_ALIGNED  shifts[C_out]                 = { 0, 0, 1, 1, };
    int16_t  WORD_ALIGNED  scales[C_out]                 = { 0x4000, 0x4000, 0x4000, 0x2000, };
    int8_t   WORD_ALIGNED Y_expected[C_out] = { 3, 2, 3, 3, };

    PRINTF("test_fc_deepin_shallowout_8_case1_5()...\n");
...
#define VECTOR_FMT      ("test_data/fc_deepin_shallowout_8_case2.%u.dat")
#include "../test_data/fc_deepin_shallowout_8_case2.h"
void test_fc_deepin_shallowout_8_case2()
{
    ...
    int8_t  Y_check[] = { Y_CHECK };

    PRINTF("test_fc_deepin_shallowout_8_case2()...\n");
    ...
    for(int v = 0; v < TEST_VECTORS; v++){
        ...
        int8_t  WORD_ALIGNED  Y_c[C_out];
        memset(Y_c, 0xCC, sizeof(Y_c));
        fc_deepin_shallowout_8_c((int8_t*) W, (int32_t*) B, (int8_t*) X, (int8_t*) Y_c, 
                                C_out, C_in, shifts, scales);
#endif
#if TEST_ASM
        PRINTF("\t\tASM...\n");
        int8_t WORD_ALIGNED Y_asm[C_out];
        memset(Y_asm, 0xCC, sizeof(Y_asm));
        fc_deepin_shallowout_8_asm((int8_t*) W, (int32_t*) B, (int8_t*) X, (int8_t*) Y_asm, 
                               C_out, C_in, shifts, scales);
#endif
...
#define TEST_VECTORS    (10)
#define VECTOR_FMT      ("test_data/fc_deepin_shallowout_8_case3.%u.dat")
#include "../test_data/fc_deepin_shallowout_8_case3.h"
void test_fc_deepin_shallowout_8_case3()
{
    ...
    PRINTF("test_fc_deepin_shallowout_8_case3()...\n");
...
void test_fc_deepin_shallowout_8()
{
    test_fc_deepin_shallowout_8_case1();
    test_fc_deepin_shallowout_8_case1_5();
    test_fc_deepin_shallowout_8_case2();
    test_fc_deepin_shallowout_8_case3();
}
