                ...
                stage("Build x86 Mac runtime") {
                    ...
                    steps {
                        ...
                        dir("xformer") {
                            ...
                            sh "./bazelisk-darwin-amd64 build //:xcore-opt --copt=-fvisibility=hidden --apple_crosstool_top=//local_config_cc:toolchain --crosstool_top=//local_config_cc:toolchain --copt=-mavx --copt=-mmacosx-version-min=10.13 --linkopt=-mmacosx-version-min=10.13 --linkopt=-dead_strip --distinct_host_configuration=false --//:disable_version_check"
                        }
                        dir("python") {
                ...
                stage("Build Arm Mac runtime") {
                    ...
                    steps {
                        ...
                        dir("xformer") {
                            ...
                            // TODO: Fix issue with XCode not being there
                            sh "./bazelisk-darwin-arm64 build //:xcore-opt --cpu=darwin_arm64 --apple_crosstool_top=//local_config_cc:toolchain --crosstool_top=//local_config_cc:toolchain --copt=-fvisibility=hidden --copt=-mmacosx-version-min=11.0 --linkopt=-mmacosx-version-min=11.0 --linkopt=-dead_strip --//:disable_version_check"
                        }
                        dir("python") {
