        ...
        self.core_model = tf.keras.Sequential(
            ...
            layers=[
                ...
                tf.keras.layers.Conv2D(
                    5, kernel_size=5, strides=2, activation="relu", name="conv_1"
                ),
                tf.keras.layers.Conv2D(
                    50, kernel_size=5, strides=2, activation="relu", name="conv_2"
                ),
    ...
    def build(self):
        ...
        self.core_model = tf.keras.Sequential(
            ...
            layers=[
                tf.keras.Input(shape=(29, 29, 1), name="input"),
                tf.keras.layers.Conv2D(
                    8, kernel_size=5, strides=2, activation="relu", name="conv_1"
                ),
                tf.keras.layers.Conv2D(
                    64, kernel_size=5, strides=2, activation="relu", name="conv_2"
                ),
                tf.keras.layers.Flatten(name="flatten"),
