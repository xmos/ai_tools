...
def model(build_model, input_shape, pool_size, strides, padding, fused_activation):
    return build_model(input_shape=input_shape, padding=padding,
...
def test_non_matching_input_channels(trf_pass, build_model,
                                     input_size, non_matching_input_channels,
                                     pool_size, strides, padding,
                                     fused_activation):
    input_shape = (*input_size, non_matching_input_channels)
    model = build_model(input_shape=input_shape, padding=padding,
                        pool_size=pool_size, strides=strides,
                        fused_activation=fused_activation)
    _test_non_matching_params(trf_pass, model)


def test_non_matching_fused_activation(trf_pass, build_model,
                                       input_shape,
                                       pool_size, strides, padding,
...
def test_non_matching_input_height(trf_pass, build_model,
                                   input_width, non_matching_input_height, input_channels,
                                   pool_size, strides, padding,
                                   fused_activation):
...
def test_non_matching_input_width(trf_pass, build_model,
                                  input_width, input_height, non_matching_input_channels,
                                  pool_size, strides, padding,
                                  fused_activation):
...
def test_non_matching_pool_h(trf_pass, build_model,
                             input_shape,
                             non_matching_pool_h, pool_w,
                             strides, padding,
                             fused_activation):
    model = build_model(input_shape=input_shape, padding=padding,
...
def test_non_matching_pool_w(trf_pass, build_model,
                             input_shape,
                             pool_h, non_matching_pool_w,
                             strides, padding,
                             fused_activation):
    model = build_model(input_shape=input_shape, padding=padding,
...
def test_non_matching_stride_h(trf_pass, build_model,
                               input_shape,
                               pool_size, padding,
                               non_matching_stride_h, stride_w,
                               fused_activation):
    model = build_model(input_shape=input_shape, padding=padding,
                        pool_size=pool_size,
...
def test_non_matching_stride_w(trf_pass, build_model,
                               input_shape,
                               pool_size, padding,
                               stride_h, non_matching_stride_w,
                               fused_activation):
    model = build_model(input_shape=input_shape, padding=padding,
                        pool_size=pool_size,
