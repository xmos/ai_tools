...
./generate_conv2d_deepin_deepout_relu.py -v --bias_init
...
./generate_conv2d_deepin_deepout_relu.py -v --bias_init unif 2 3 --seed_init 42

./generate_conv2d_deepin_deepout_relu.py -v --weight_init
...
./generate_conv2d_deepin_deepout_relu.py -v --weight_init unif 21 34 --seed_init 42

./generate_conv2d_deepin_deepout_relu.py -v --weight_init --bias_init
./generate_conv2d_deepin_deepout_relu.py -v --weight_init unif --bias_init
...
./generate_conv2d_deepin_deepout_relu.py -v --weight_init const --bias_init
...
./generate_conv2d_deepin_deepout_relu.py -v --weight_init unif 98.7 159.7 --bias_init const 23.3 --seed_init 42
./generate_conv2d_deepin_deepout_relu.py -v --weight_init unif 25.84 41.81 --bias_init unif 37.7 61.0 --seed_init 42
