...
func.func @replace_pad_negative_zeropoint(%arg0: tensor<?x4x1x48x!quant.uniform<i8:f32, 0.0078384801745414734:-10>>) -> tensor<?x4x3x48x!quant.uniform<i8:f32, 0.0078384801745414734:-10>> attributes {tf.entry_function = {inputs = "zero_padding2d_input_int8", outputs = "Identity_int8"}} {
...
func.func @replace_pad_positive_zeropoint(%arg0: tensor<?x4x1x48x!quant.uniform<i8:f32, 0.0078384801745414734:10>>) -> tensor<?x4x3x48x!quant.uniform<i8:f32, 0.0078384801745414734:10>> attributes {tf.entry_function = {inputs = "zero_padding2d_input_int8", outputs = "Identity_int8"}} {
  %0 = "tfl.pseudo_const"() {value = dense<[[0, 0], [0, 0], [2, 0], [0, 0]]> : tensor<4x2xi32>} : () -> tensor<4x2xi32>
  // CHECK: xc.pad
...
func.func @replace_pad_with_invalid_shape(%arg0: tensor<?x4x48x!quant.uniform<i8:f32, 0.0078384801745414734:-1>>) -> tensor<?x4x48x!quant.uniform<i8:f32, 0.0078384801745414734:-1>> attributes {tf.entry_function = {inputs = "zero_padding2d_input_int8", outputs = "Identity_int8"}} {
...
func.func @replace_pad_with_batchchannel_padding(%arg0: tensor<?x4x1x48x!quant.uniform<i8:f32, 0.0078384801745414734:-1>>) -> tensor<?x4x3x48x!quant.uniform<i8:f32, 0.0078384801745414734:-1>> attributes {tf.entry_function = {inputs = "zero_padding2d_input_int8", outputs = "Identity_int8"}} {
...
// CHECK-LABEL: replace_pad_with_invalid_bytes_per_pixel
func.func @replace_pad_with_invalid_bytes_per_pixel(%arg0: tensor<?x4x1x47x!quant.uniform<i8:f32, 0.0078384801745414734:-1>>) -> tensor<?x4x3x47x!quant.uniform<i8:f32, 0.0078384801745414734:-1>> attributes {tf.entry_function = {inputs = "zero_padding2d_input_int8", outputs = "Identity_int8"}} {
  %0 = "tfl.pseudo_const"() {value = dense<[[0, 0], [0, 0], [2, 0], [0, 0]]> : tensor<4x2xi32>} : () -> tensor<4x2xi32>
  // CHECK-NOT: xc.pad
