...
'''
Interface for model testing and conversion.
'''
class Model(ABC):
    '''
    General class that defines a Model for testing purposes. This is the parent class of the Keras, Saved, and Function models.
    '''
...
class KerasModel(Model):
    '''
    Abstract class to define Keras models. Inherit from Model.
    '''
    @abstractmethod
    def build(self): 
        pass
...
class SavedModel(Model):
    '''
    Abstract class to define TensorFlow models. Inherit from Model.
    '''
    @abstractmethod
    def build(self): 
        pass
...
class FunctionModel(Model):
    '''
    Abstract class to define TensorFlow Function models. Inherit from Model.
    '''
    @abstractmethod
    def build(self): 
        pass
