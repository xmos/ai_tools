...
def build_maxpool_model(input_shape):
    model = XCOREModel()
    ...
    op = subgraph.create_operator(OperatorCode(BuiltinOpCodes.MAX_POOL_2D),
...
def matching(request):
    return build_maxpool_model(input_shape=list(request.param))
