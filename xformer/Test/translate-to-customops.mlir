...
// CHECK-SAME: XC_lookup
  %0 = "xc.lookup"(%arg0, %cst) {thread_count = 5 : i32} : (tensor<1x12x4x7x!quant.uniform<i8:f32, 0.0078384801745414734:-1>>, tensor<256xi8>) -> tensor<1x12x4x7x!quant.uniform<i8:f32, 0.0039192917756736279:-128>>
...
// CHECK: tfl.custom
// CHECK-SAME: XC_pad
// CHECK-SAME: custom_option = #tfl<const_bytes : "0x7070001800000000040000006000000030000000000000000000000000707600022105000300000001000000020000002C0000000A0A0A0A14060A2601">
