              ...
              withVS() {
                ...
                withVenv { 
                  ...
                  dir("xformer") {
                    ...
                    bat "bazelisk-windows-amd64.exe --output_user_root c:\\jenkins\\_bzl build //:xcore-opt  --action_env PYTHON_BIN_PATH="C:/Python310/python3.exe" --//:disable_version_check --remote_cache=${env.BAZEL_CACHE_URL}"
                  }
                  dir("python") { 
