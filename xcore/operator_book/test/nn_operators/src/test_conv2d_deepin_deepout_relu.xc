...
#define region_top      (2)
#define region_left     (2)
#define region_rows     (4)
#define region_cols     (4)
void test_something()
{
  ...
  #define Y_width (X_width)
    ...
    for(int block = 0; block < params.block_count; block++){
        ...
        conv2d_deepin_deepout_relu_block_asm((int8_t*)Y,  
                                                &params, 
...
void test_conv2d_deepin_deepout_relu_case1()
{
    ...
    int8_t   WORD_ALIGNED  K[C_out][K_h][K_w][C_in]      = {{{{ 0 }}}};
    data16_t WORD_ALIGNED  B[K_h][K_w][2][C_out]         = {{{{ 0 }}}};
...
void test_conv2d_deepin_deepout_relu_case2()
{
    ...
    data16_t WORD_ALIGNED  B[K_h][K_w][2][C_out];
    int8_t   WORD_ALIGNED  X[height][width][C_in];
