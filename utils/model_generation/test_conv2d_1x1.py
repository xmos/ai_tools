...
CONFIGS = {
    "default": [
        ...
        {"height": 8, "width": 2, "input_channels": 12, "output_channels": 64},
        {
            ...
            "input_init": tf.constant_initializer(1.0),
        },
        {
            "height": 1,
            "width": 4,
            "weight_init": tf.random_normal_initializer(0.0, 0.1),
            "bias_init": tf.random_normal_initializer(-0.5, 0.02),
            "input_init": tf.random_uniform_initializer(10.0),
        },
        {"num_threads": 2},
        {"num_threads": 5},
    ],
