...
DEFAULT_PATH = (
    Path(__file__).parent.joinpath("debug", "conv2d_shallowin_padded").resolve()
)


class Conv2DShallowinPadded(common.OpTestPaddedConvModel):
...
def main(raw_args=None):
    ...
    model = Conv2DShallowinPadded("conv2d_shallowin_padded", args.path)
    model.build(
        args.kernel_height,
        args.kernel_width,
        args.height,
