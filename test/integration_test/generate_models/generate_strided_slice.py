...
for i in range(len(configs['default'])):
	height = configs['default'][i]['height']
	width = configs['default'][i]['width']
	channels = configs['default'][i]['channels']
	...
	with open(os.path.join(dir,"strided_slice_"+str(i)+".tflite"),mode='wb') as file:
